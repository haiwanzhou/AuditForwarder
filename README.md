...
- 跨操作员合谋协同检测：双窗口聚合、规则引擎与行为画像、风险分级、工单核验、处置闭环与分析报表
- 日志分类与优先级管理：采集器标识、提权操作标注、双队列传输、ETW 安全日志宽松档与可视化策略配置
...
- [跨操作员合谋协同行为检测子系统-系统设计方案](跨操作员合谋协同行为检测子系统-系统设计方案.docx)（v1.1.0 新增模块设计依据）
